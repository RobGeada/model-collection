...
COPY gaussian-credit/gaussian-credit-model.xml /data1/modelmesh-example-models/openvino/gaussian-credit/1/
COPY gaussian-credit/gaussian-credit-model.bin /data1/modelmesh-example-models/openvino/gaussian-credit/1/
